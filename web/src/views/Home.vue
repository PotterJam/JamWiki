  ...
  <div class="home">
    ...
    <v-expand-transition>
      <div v-show="isEditing" class="mx-auto" id="wiki-body-wrapper">
        <WikiPane v-bind:wikiName="currentWikiName" v-on:deleteWiki="deleteWikiFromSearch" />
      </div>
    </v-expand-transition>
...
export default {
  ...
  methods: {
    ...
    addWiki() {
      if (this.createWikiModalInput == null || this.createWikiModalInput.length < 1 || this.wikiNames.includes(this.createWikiModalInput)) {
        return;
      }
